 ...
 */
export async function handleDepositDeletion(id: string, userId: string | undefined): Promise<boolean> {
  try {
 ...
 * @returns A boolean indicating whether the deletion was successful
 */
export async function handleWithdrawalDeletion(id: string, userId: string | undefined): Promise<boolean> {
  try {
 ...
 * @returns A boolean indicating whether the deletion was successful
 */
export async function handleTransferDeletion(id: string, userId: string | undefined): Promise<boolean> {
  try {
