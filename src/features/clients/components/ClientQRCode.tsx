...
export const ClientQRCode = ({
  ...
  if (!showQrCode) {
    return <Card className="p-4 bg-gradient-to-br from-violet-100 to-purple-50 shadow-lg border-purple-200 hover:shadow-xl transition-all py-0 rounded-lg w-full px-[15px] mx-[98px]">
