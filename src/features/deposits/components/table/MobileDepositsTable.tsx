...
export const MobileDepositsTable = ({ 
  ...
  return (
    <div className="space-y-4 w-full">
      {deposits.map((deposit) => {
        ...
        return (
          <div 
            ...
            className="group bg-gradient-to-br from-gray-100 to-gray-200/95 dark:from-gray-800/95 dark:to-gray-850/90 p-4 border border-gray-300/60 dark:border-gray-700/40 rounded-xl shadow-sm hover:shadow-md w-full transition-all duration-300 hover:translate-y-[-2px] backdrop-blur-sm animate-in active:bg-gray-200/80 dark:active:bg-gray-750/80"
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-1.5 bg-gray-200/80 dark:bg-gray-800/60 px-2 py-1 rounded-md border border-gray-300/50 dark:border-gray-700/30">
            ...
            <div className="text-sm text-muted-foreground mb-3 px-2">
              ...
              <p className="mt-1.5 line-clamp-2 text-gray-600/90 dark:text-gray-300/80 bg-gray-50/90 dark:bg-gray-800/40 px-3 py-2 rounded-lg border border-gray-300/50 dark:border-gray-700/30">{deposit.description}</p>
            </div>
      ...
      {deposits.length > 0 && (
        <div className="mt-5 border-t border-gray-300/50 dark:border-gray-700/30 pt-4 bg-gradient-to-br from-gray-100/90 to-gray-200/80 dark:from-gray-800/90 dark:to-gray-850/80 p-4 rounded-xl shadow-sm">
      ...
      {deposits.length === 0 && (
        <div className="text-center py-8 text-gray-500 dark:text-gray-400 bg-gradient-to-br from-gray-50/90 to-gray-100/80 dark:from-gray-800/80 dark:to-gray-850/60 rounded-lg border border-gray-300/50 dark:border-gray-700/30 backdrop-blur-sm">
