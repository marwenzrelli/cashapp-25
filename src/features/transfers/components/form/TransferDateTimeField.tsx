...
interface TransferDateTimeFieldProps {
  date: Date;
...
export const TransferDateTimeField = ({ date, setDate, time, setTime }: TransferDateTimeFieldProps) => {
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="date">Date et heure du virement</Label>
